...
// Middleware kiểm tra quyền tạo đặt bàn (Receptionist, Manager)
export const requireReservationCreation = (req, res, next) => {
  return authorize('Receptionist', 'Manager')(req, res, next);
};
