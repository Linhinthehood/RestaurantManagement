...
// Middleware kiểm tra quyền quản lý bàn (Manager, Receptionist)
export const requireTableManagement = (req, res, next) => {
  return authorize('Manager', 'Receptionist')(req, res, next);
};

// Middleware kiểm tra quyền xem thông tin bàn (tất cả role)
